...
import { ILogRepository } from '@libs/log/contracts/log.repository.contracts';
import { LogModel } from '@libs/core/infrastructure/database/mongoose/schemas/log.model';
import { LogEntity } from '@libs/log/domain/entities/log.entity';
import { ILog } from '@libs/log/domain/interfaces/log.interface';
