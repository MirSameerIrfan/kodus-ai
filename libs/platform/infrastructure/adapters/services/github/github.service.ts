...
This suggestion is generated by an experimental feature designed to produce commitable code changes.
It analyzes existing suggestions and verifies whether they can be committed without breaking the current code file.
Please review the changes carefully before applying them, as the feature is still under development and may not be 100% accurate.
</details>
`
            : '';
