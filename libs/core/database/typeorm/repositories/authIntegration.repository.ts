...
import { AuthIntegrationModel } from '@libs/core/database/typeorm/schema/authIntegration.model';
...
import { mapSimpleModelToEntity } from '@libs/common/infrastructure/repositories/mappers';
