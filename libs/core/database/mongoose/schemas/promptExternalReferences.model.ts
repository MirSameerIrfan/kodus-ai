...
import { IFileReference, IPromptReferenceSyncError, PromptProcessingStatus, PromptSourceType } from '@libs/code-review/domain/prompts/interfaces/promptExternalReference.interface';
